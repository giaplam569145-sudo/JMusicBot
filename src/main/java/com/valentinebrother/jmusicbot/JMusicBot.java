...
import com.valentinebrother.jmusicbot.commands.CommandRegistry;
import com.valentinebrother.jmusicbot.config.ConfigLoader;
...
public class JMusicBot
{
    ...
    private static void startBot()
    {
        ...
        try
        {
            JDA jda = JDABuilder.createDefault(config.getToken(), Arrays.asList(INTENTS))
