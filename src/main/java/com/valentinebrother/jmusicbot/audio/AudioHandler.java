...
import com.valentinebrother.jmusicbot.playlist.PlaylistLoader.Playlist;
import com.valentinebrother.jmusicbot.queue.AbstractQueue;
import com.valentinebrother.jmusicbot.settings.QueueType;
import com.valentinebrother.jmusicbot.utils.TimeUtil;
import com.valentinebrother.jmusicbot.settings.RepeatMode;
...
import com.valentinebrother.jmusicbot.settings.Settings;
import com.valentinebrother.jmusicbot.utils.FormatUtil;
...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler
{
    ...
    public MessageCreateData getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageCreateBuilder()
                .addContent(FormatUtil.filter(manager.getBot().getConfig().getSuccess()+" **Now Playing...**"))
